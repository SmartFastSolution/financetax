            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-5 col-xs-6">
                        <div class="text">
                            <p><span><a href="#">Tu Consultoria OnLine </a></span> &copy; 2017 Todos Los Derechos Reservados.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-3 col-xs-4">
                        <div class="footer-logo">
                            <p><a href="#">   <img class="nav_logo_img img-fluid top-left" src="digital/images/logo1.png"></a></p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-2">
                        <div class="icon">
                            <p><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                ...
                                <a href="#"> <i class="fa fa-telegram" aria-hidden="true"></i></a></p>
