...
@section('content')
    <h1 class="text-center font-weight-bold">Consultar Formulario 104</h1>
                            ...
                            @foreach ($empresa as $compra)
                                <tr>
                                  ...
                                  <td class="text-center ">${{ $compra->costo }}</td>
                                    ...
                                    <td width="10px">
                                      <a class="btn btn-icon icon-left btn-primary" href="/reportes/formulario104/consultar/{{$compra->shop_id}}">
