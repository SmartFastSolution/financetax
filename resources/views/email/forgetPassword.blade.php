				...
				<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
					<tr>
						<td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #00a5b5">
							<a href="https://tenable.com"><img class="top-image" src="https://solution.fumicert.com/digital/images/solutionlogo1.png" style="line-height: 1;width: 600px;" alt="Tenable Network Security"></a>
						</td>
					</tr>
					<tr>
							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
                                    ...
                                    <img class="top-image" src="https://info.tenable.com/rs/tenable/images/webinar-no-text.png" width="560"/><br><br>
			                             <a style="color:#ffffff; background-color: #ff8300;  border: 10px solid #ff8300; border-radius: 3px; text-decoration:none;" href="{{ route('reset.password.get', $token) }}">Reiniciar Contraseña</a>
                                         <br><br>
                                         <label for="">Si el bot&oacute;n no funciona correctamente puede reiniciar su contraseña desde la siguiente URL:</label>
                                         <br>
...
<div id="address" class="mktEditable">
										<b>SOLUTION FINANCE TAX</b><br>
                                        Avenida Siempre Viva
Guayaquil, <br>  Entre la que mira y sale <br>
                            <a style="color: #00a5b5;" href="https://solution.fumicert.com/contactenos">Contactenos</a>
</div>
									</td>
								</tr>
							</table>
