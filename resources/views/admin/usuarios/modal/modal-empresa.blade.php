    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Clave de Acceso</label>
                        ...
                        @elseif(!$flagShop)
                            <input wire:model.defer="clave_acceso"  type="text" class="form-control" disabled>
                        @endif
                </div>
            </div>
            <div class="modal-footer bg-whitesmoke br">
                ...
                @else
                    <button type="button" class="btn btn-primary" wire:click="CrearEmpresa" id="btnAñadir" disabled>Añadir Empresa</button>
                @endif
            </div>
        </div>
    </div>
